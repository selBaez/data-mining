...
Finally, we tested the length of pre-training for the transductor phase. To do so, the number of epochs ranged from 1 to 30.
...
We tried also changing the optimization algorithm used to train the model. In
Figure~\ref{fig:ensemble_d11} is shown the performance of the ensemble of models
